...
public class CircularLoader : MonoBehaviour
{
    ...
    private bool useGazeToClick = false; 
    void Start()
    {       
        ...
        useGazeToClick =  ( WinMRSnippets.Samples.Input.WinMRInputModule.Instance.AllowedCursorInput & WinMRSnippets.Samples.Input.InputOption.Gaze ) != WinMRSnippets.Samples.Input.InputOption.None ; 
        if ( FinalTime == 0f )
        {
